...
import com.plcoding.bookpedia.book.presentation.SelectedViewModel
            ...
            navigation<Route.BookGraph>(
                ...
                composable<Route.BookList> {
                    ...
                    val selectedBookViewModel = it
                        .sharedKoinViewModel<SelectedViewModel>(navController)
                ...
                composable<Route.BookDetail> {
                    ...
                    val selectedBook by selectedBookViewModel
                        .selectedBook.collectAsStateWithLifecycle()
                    ...
                    LaunchedEffect(selectedBook) {
                        selectedBook?.let {
                            viewModel.onAction(
                                BookDetailAction.OnSelectedBookChange(it)
                            )
                        }
                    }
